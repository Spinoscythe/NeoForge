...
public class NeoForgeDataMaps {
     ...
     * If you want more advanced behavior, see {@link IBlockExtension#getToolModifiedState(BlockState, UseOnContext, ItemAbility, boolean)} and {@link BlockEvent.BlockToolModificationEvent}.
     */
    public static final DataMapType<Block, Strippable> STRIPPABLES = DataMapType.builder(
            id("stripppables"), Registries.BLOCK, Strippable.CODEC).synced(Strippable.STRIPPED_BLOCK_CODEC, false).build();
